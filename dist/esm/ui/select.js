...
function Select(props) {
  return async (providers, _req) => {
    const visible = Object.entries(providers).filter(([key]) => !props?.providers?.[key]?.hide);
    if (visible.length === 1) {
      return Response.redirect(new URL(`/${visible[0][0]}/authorize`, _req.url).toString(), 302);
    }
    const jsx = /* @__PURE__ */ jsxDEV(Layout, {
      children: /* @__PURE__ */ jsxDEV("div", {
        "data-component": "form",
        children: visible.map(([key, type]) => {
